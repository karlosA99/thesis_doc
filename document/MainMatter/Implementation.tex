...
De esta forma, se analiza el impacto de utilizar distintos modelo de \emph{BERT} para la representaci\'on 
...
En el Escenario II, se emplea la versi\'on final del corpus para entrenar y evaluar el \emph{baseline} de aprendizaje 
autom\'atico. Para el \emph{baseline} humano, se utilizan las versiones 1 y 2 del corpus para evaluar el clasificador
propuesto en el \emph{baseline} de aprendizaje autom\'atico. 
...
En ambos casos, se elimina el valor del atributo raza de uno de los textos. La raz\'on 
detr\'as de esto es que dicho valor conten\'ia la \'unica instancia de la clase \emph{Native American} en el corpus. 
