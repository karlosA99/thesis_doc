...
\section{Datasets en el an\'alisis de sesgos}
    ...
    \begin{itemize}
        \item \textbf{Adult}: Tambi\'en conocido como \emph{Census Income}, este dataset contiene 48842 registros de 
        ...
        \item \textbf{German Credit}: El dataset \emph{German Credit} contiene registros del estado financiero de 1000 individuos,
