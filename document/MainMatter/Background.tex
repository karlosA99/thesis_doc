...
Adem\'as, se hace especial \'enfasis en el papel que juegan los datasets con atributos protegidos anotados en el desarrollo
...
\section{Fuentes y Tipos de Sesgos}
    ...
    \begin{itemize}
        \item \textbf{Sesgo hist\'orico}: Es el sesgo y los problemas sociot\'ecnicos ya existentes en el mundo y puede 
...
con estos, o bien, modificar las etiquetas de algunos objetos en el dataset~\parencite{preproc}. Una ventaja de estas t\'ecnicas es que son independientes
...
\section{Datasets en el an\'alisis de sesgos}
    ...
    \begin{itemize}
        \item \textbf{Adult}: Tambi\'en conocido como \emph{Census Income}, este dataset contiene $48\,842$ registros de 
        ...
        \item \textbf{Compas}: Este dataset contiene $18\,610$ registros de los acusados del condado de Broward, Florida,
        ...
        \item \textbf{German Credit}: El dataset \emph{German Credit} contiene registros del estado financiero de $1\,000$ individuos,
...
Por lo tanto, en el contexto de esta tesis, que tiene como objetivo el dise\~no y evaluaci\'on de un dataset de estructura no tabular
