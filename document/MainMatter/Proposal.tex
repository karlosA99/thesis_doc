...
\begin{table}[htpb]
    ...
    \resizebox{\textwidth}{!}{
        ...
        \toprule
        \toprule
        \textbf{M\'etrica de concordancia} &&\textbf{$A_1$ vs $A_2$} & \textbf{$A_1$ vs $F$} & \textbf{$A_2$ vs $F$} \\
        \midrule
        \midrule
        \multirow{3}{4em}{G\'enero} & Media & & & \\
        \cmidrule{2-5}
        & Varianza & & & \\
        \cmidrule{2-5}
        & Desviaci\'on est\'andar & & & \\
        \midrule
        \multirow{3}{4em}{Raza} & Media & & & \\
        \cmidrule{2-5}
        & Varianza & & & \\
        \cmidrule{2-5}
        & Desviaci\'on est\'andar & & & \\
        \midrule
        \multirow{4}{4em}{G\'enero y Raza} & Macro Agr & & & \\
        \cmidrule{2-5}
        & Media Micro Agr & & & \\
        \cmidrule{2-5}
        & Varianza Micro Agr & & & \\
        \cmidrule{2-5}
        & Desviaci\'on est\'andar Micro Agr & & & \\
        \bottomrule
        \end{tabular}}
