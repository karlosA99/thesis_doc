...
y~\ref{subsection:human_baseline}. Adem\'as se calculan para cada \emph{baseline} como m\'etricas de 
desempe\~no la medida~F1, la exactitud, la precisi\'on y el recobrado para cada atributo por 
separado, todas ellas en \emph{macro} y en \emph{micro}. 
...
El preprocesamiento se basa en obtener representaciones vectoriales sem\'anticas de los textos. Para ello, 
se utiliza el tokenizador y modelo 
...
Los resultados se discuten en la secci\'on~\ref{section:results}.
...
clasificador contra la habilidad de anotaci\'on humana en condiciones ideales, y as\'i 
...
consiste en utilizar las anotaciones realizadas por los anotadores humanos como conjunto de
evaluaci\'on para el clasificador entrenado en el \emph{baseline} de aprendizaje autom\'atico.
...
%#TODO: Preguntar al profe aqui quien es el que debe rendir peor porque no me queda claro.
